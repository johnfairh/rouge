  ...
  module Lexers
    class Swift < RegexLexer
      ...
      keywords = Set.new %w(
        ...
        associativity async didSet get infix inout mutating none nonmutating operator override postfix precedence prefix set unowned weak willSet throws rethrows precedencegroup
